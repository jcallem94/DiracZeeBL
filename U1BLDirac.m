...
Model`Name = "DiracZee";
Model`NameLaTeX ="Dirac Zee Model";
Model`Authors = "Julian Calle, Diego Restrepo and Oscar Zapata";
Model`Date = "2019-01-23";
...
ScalarFields[[3]] = {S1, 1, s1,          -1, 1,  1, -2};
ScalarFields[[4]] = {S2, 1, s2,          -1, 1,  1, -5};
...
DEFINITION[EWSB][MatterSector]=   
    {
     {{phiH,phiB},{hh,ZH}},
     {{sigmaH,sigmaB},{Ah,ZA}},
     {{conj[Hp],conj[s1],conj[s2]},{Hm,ZP}},
     {{{dL}, {conj[dR]}}, {{DL,Vd}, {DR,Ud}}},
     {{{uL}, {conj[uR]}}, {{UL,Vu}, {UR,Uu}}},
     {{{eL}, {conj[eR]}}, {{EL,Ve}, {ER,Ue}}},
     {{vL,conj[vR],conj[vR3]}, {VL,ZM}}
};  
